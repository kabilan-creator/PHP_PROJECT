...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if (empty($error)) {
        ...
        $sql ="INSERT INTO admin (NAME,AMAIL,APASS,account_activation)
                    VALUES(?, ?, ?,?) ";
        ...
        if($stmt === false) {
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                Click <a href="localhost/new project/activation.php?token=$activation_token ">here</a>
                ...
                header('Location: email_verfication.php');// Redirect to dashboard
                exit();
